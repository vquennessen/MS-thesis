run_base_model <- function(Species, num_sims, Scenario, Final_DRs) {
  ...
  for (i in 1:num_sims) {
    ...
    output <- base_model(Species, R0, A, MPA, Time1, Time2, Recruitment_mode, 
                         ...
                         Control_rules, Output.N, Output.Abundance, 
                         Output.Biomass, Output.SSB, Output.Yield, 
  ...
  if (Scenario == 'None') {
    filepath4 = paste('../data/', Scenario, '/', Species, '/', Q, '_SSB.Rda', sep = '')
    filepath5 = paste('../data/', Scenario, '/', Species, '/', Q, '_effort.Rda', sep = '')
    filepath6 = paste('../data/', Scenario, '/', Species, '/', Q, '_DR.Rda', sep = '')
