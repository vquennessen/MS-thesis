#' Victoria Quennessen
#' Parameters for Study Species
#' 4/18/2019

parameters = function(study_species) {
  
  #' Loads the life history characteristics for a species
  #' 
  #' Arguments:
  #'   study_species: a character string of a species name
  #'   
  #' Returns:
  #'   the parameters needed to run the popDyn function
