no_stochasticity <- function(Species, num_sims) {
  ...
  filepath1 = paste('../data/no_stochasticity/all_FDR_values/', Species, '/', 
                    Q, '_N.Rda', sep = '')
  filepath2 = paste('../data/no_stochasticity/all_FDR_values/', Species, '/', 
                    Q, '_biomass.Rda', sep = '')
  filepath3 = paste('../data/no_stochasticity/all_FDR_values/', Species, '/', 
                    Q, '_SSB.Rda', sep = '')
  filepath4 = paste('../data/no_stochasticity/all_FDR_values/', Species, '/', 
                    Q, '_yield.Rda', sep = '')
  filepath5 = paste('../data/no_stochasticity/all_FDR_values/', Species, '/', 
                    Q, '_effort.Rda', sep = '')
  filepath6 = paste('../data/no_stochasticity/all_FDR_values/', Species, '/', 
                    Q, '_DR.Rda', sep = '')
  filepath7 = paste('../data/no_stochasticity/all_FDR_values/', Species, '/', 
                    Q, '_abundance.Rda', sep = '')
